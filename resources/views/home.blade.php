...
@section('diventa_sviluppatore')
<div class="row diventa_sviluppatore">
  <div class="sinistro col-xs-12 col-md-6 col-lg-offset-2 col-lg-4">
    <h1 class="text-success">Diventa sviluppatore web</h1>
  ...
  <div class="destro col-xs-12 col-md-6 col-lg-6">
    <img class="notebook_img" src="https://www.boolean.careers/images/common/mac2x.png" alt="">
  </div>
</div>
@endsection
  ...
  <div class="partners">
      <div class="row text-center">
        <div class="col-xs-12 col-md-12">
            <h3 class="white">I nostri studenti sono stati assunti da</h3>
        </div>
      </div>
